...
class HTTPServer:
    ...
    def serve_forever(self):
        ...
        print("Listen the port %d" % self.port)     # 打印端口号
        # 加入等待客户端指令的监控列表
    ...
    def handle(self, connfd):
        ...
        # 提取请求内容
        request_line = request.splitlines()[0]  # 请求行
        info = request_line.decode().split(' ')[1]  # 请求内容 \
    ...
    def get_data(self,connfd,info):
        ...
        responseHeaders += '\r\n'
        responseBody = "waiting for responseBody"
